...
const ProductDetail = () => {
  ...
  const [hoveredThumbnailIndex, setHoveredThumbnailIndex] = useState(null);
              ...
              {product.images.map((image, index) => (
                <button
                  ...
                  className={`rounded-md overflow-hidden border-2 transition-all ${
                    activeImageIndex === index ? 'border-black' : 
                    hoveredThumbnailIndex === index ? 'border-gray-500' : 'border-transparent'
                  }`}
                >
                  <img 
                    src={image} 
                    ...
                    className={`w-full aspect-square object-cover transition-opacity ${
                      hoveredThumbnailIndex === index ? 'opacity-80' : 'opacity-100'
                    }`}
                  />
                </button>
              ))}
